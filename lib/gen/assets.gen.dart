...
class $AssetsImagesIllustrationsGen {
  ...
  /// File path: assets/images/illustrations/home_hero.png
  AssetGenImage get homeHero => const AssetGenImage('assets/images/illustrations/home_hero.png');

  /// List of all assets
  List<AssetGenImage> get values => [homeHero];
}
